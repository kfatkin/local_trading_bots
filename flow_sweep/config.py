...
PARTIAL_EXIT_PCT = env_float("FLOW_SWEEP_PARTIAL_EXIT_PCT", 0.50)
RUNNER_PROFIT_FLOOR_ENTRY_MULTIPLE = env_float("FLOW_SWEEP_RUNNER_PROFIT_FLOOR_ENTRY_MULTIPLE", 1.15)
RUNNER_PROFIT_FLOOR_PARTIAL_MULTIPLE = env_float("FLOW_SWEEP_RUNNER_PROFIT_FLOOR_PARTIAL_MULTIPLE", 0.85)
RUNNER_EXTENSION_R_MULTIPLE = env_float("FLOW_SWEEP_RUNNER_EXTENSION_R_MULTIPLE", 2.0)
RUNNER_STALL_R_MULTIPLE = env_float("FLOW_SWEEP_RUNNER_STALL_R_MULTIPLE", 1.25)
RUNNER_STALL_MINUTES = env_int("FLOW_SWEEP_RUNNER_STALL_MINUTES", 60)
SECOND_PARTIAL_EXIT_R_MULTIPLE = env_float("FLOW_SWEEP_SECOND_PARTIAL_EXIT_R_MULTIPLE", 2.5)
SECOND_PARTIAL_EXIT_PCT = env_float("FLOW_SWEEP_SECOND_PARTIAL_EXIT_PCT", 0.25)
PRE_BREAKEVEN_OPTION_LOCK_ENABLED = env_flag("FLOW_SWEEP_PRE_BREAKEVEN_OPTION_LOCK_ENABLED", True)
PRE_BREAKEVEN_OPTION_LOCK_TRIGGER_PCT = env_float("FLOW_SWEEP_PRE_BREAKEVEN_OPTION_LOCK_TRIGGER_PCT", 0.15)
PRE_BREAKEVEN_OPTION_FLOOR_PCT = env_float("FLOW_SWEEP_PRE_BREAKEVEN_OPTION_FLOOR_PCT", 0.02)
PRE_BREAKEVEN_OPTION_HARD_STOP_LOSS_PCT = env_float("FLOW_SWEEP_PRE_BREAKEVEN_OPTION_HARD_STOP_LOSS_PCT", 0.30)
NO_PROGRESS_EXIT_ENABLED = env_flag("FLOW_SWEEP_NO_PROGRESS_EXIT_ENABLED", True)
NO_PROGRESS_MINUTES = env_int("FLOW_SWEEP_NO_PROGRESS_MINUTES", 90)
NO_PROGRESS_MIN_OPTION_GAIN_PCT = env_float("FLOW_SWEEP_NO_PROGRESS_MIN_OPTION_GAIN_PCT", 0.0)
DAILY_PROFIT_LOCK_ENABLED = env_flag("FLOW_SWEEP_DAILY_PROFIT_LOCK_ENABLED", True)
DAILY_PROFIT_LOCK_TRIGGER_PCT = env_float("FLOW_SWEEP_DAILY_PROFIT_LOCK_TRIGGER_PCT", 0.02)
DAILY_PROFIT_LOCK_FLOOR_PCT = env_float("FLOW_SWEEP_DAILY_PROFIT_LOCK_FLOOR_PCT", 0.0125)
DAILY_PROFIT_LOCK_DRAWDOWN_PCT = env_float("FLOW_SWEEP_DAILY_PROFIT_LOCK_DRAWDOWN_PCT", 0.0075)
DAILY_PROFIT_LOCK_BLOCKS_NEW_ENTRIES = env_flag("FLOW_SWEEP_DAILY_PROFIT_LOCK_BLOCKS_NEW_ENTRIES", True)
...
ENABLE_CONTINUATION_FVG = env_flag("FLOW_SWEEP_ENABLE_CONTINUATION_FVG", False)
CONTINUATION_DISPLACEMENT_LOOKBACK = env_int("FLOW_SWEEP_CONTINUATION_DISPLACEMENT_LOOKBACK", 5)
CONTINUATION_DISPLACEMENT_MIN_RANGE_MULTIPLE = env_float("FLOW_SWEEP_CONTINUATION_DISPLACEMENT_MIN_RANGE_MULTIPLE", 1.25)
CONTINUATION_MAX_ZONE_AGE_BARS = env_int("FLOW_SWEEP_CONTINUATION_MAX_ZONE_AGE_BARS", 6)
