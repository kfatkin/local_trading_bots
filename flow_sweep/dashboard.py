...
def position_payload(symbol, position, broker_position=None):
    ...
    return {
        ...
        "runner_profit_floor_option_price": round_or_none(position.get("runner_profit_floor_option_price"), 4),
        "runner_max_r_multiple": round_or_none(position.get("runner_max_r_multiple"), 2),
        "runner_extension_reached": bool(position.get("runner_extension_reached")),
        "runner_stall_r_multiple": round_or_none(position.get("runner_stall_r_multiple"), 2),
        "runner_stall_minutes": position.get("runner_stall_minutes"),
        ...
        "partial_exit_fill_price": round_or_none(position.get("partial_exit_fill_price"), 4),
        "partial_exit_skipped_reason": position.get("partial_exit_skipped_reason"),
        "second_partial_exit_pct": round_or_none(position.get("second_partial_exit_pct"), 2),
        "second_partial_taken": bool(position.get("second_partial_taken")),
        "second_partial_qty_requested": to_int_qty(position.get("second_partial_qty_requested", 0)),
        "second_partial_trigger_r_multiple": round_or_none(position.get("second_partial_trigger_r_multiple"), 2),
        "second_partial_requested_at": position.get("second_partial_requested_at"),
        "second_partial_fill_price": round_or_none(position.get("second_partial_fill_price"), 4),
        "pre_breakeven_option_floor_price": round_or_none(position.get("pre_breakeven_option_floor_price"), 4),
        "pre_breakeven_peak_option_price": round_or_none(position.get("pre_breakeven_peak_option_price"), 4),
        "pre_breakeven_no_progress_elapsed_minutes": round_or_none(position.get("pre_breakeven_no_progress_elapsed_minutes"), 1),
        "pre_breakeven_no_progress_gain_pct": round_or_none(position.get("pre_breakeven_no_progress_gain_pct"), 4),
...
def dashboard_status_payload():
    ...
    return {
        "bot": {
            ...
            "second_partial_exit_r_multiple": SECOND_PARTIAL_EXIT_R_MULTIPLE,
            ...
            "daily_profit_lock_enabled": DAILY_PROFIT_LOCK_ENABLED,
            "daily_profit_lock_trigger_pct": DAILY_PROFIT_LOCK_TRIGGER_PCT,
            "daily_profit_lock_floor_pct": DAILY_PROFIT_LOCK_FLOOR_PCT,
            "daily_profit_lock_drawdown_pct": DAILY_PROFIT_LOCK_DRAWDOWN_PCT,
            "daily_profit_lock_blocks_new_entries": DAILY_PROFIT_LOCK_BLOCKS_NEW_ENTRIES,
